dataset = {
    ...
    "https://arab.org/portal/lebanon/where-to-donate" : {
        "userSummary" : "Looking for ways to donate Lebanon, but don’t know who’s legit?",
    ...
    "https://remix.aljazeera.com/aje/PalestineRemix/": {
        "userSummary": "Al Jazeera’s Palestine Remix offers a large archive of documentation and visual resources on Palestine, useful for research and inspiration.",
        "userTags": ["category/General Resource Databases"],
        "ogTitle": "",
        "ogDescript": ""
    },
    ...
    "https://drive.google.com/file/d/17GcQtPruWzfkJmyW8-i9Qj4WTQ8WIT2A/view": {
        "userSummary": "In Defense of Palestine: An Advocate’s Toolkit, a resource for activists to effectively defend the Palestinian cause.",
    ...
    "https://www.icorn.org/icorn-cities-refuge": {
        "userSummary": "A list of ICORN’s 70 Cities of Refuge, which offer temporary shelter to persecuted writers, artists, and journalists.",
        "userTags": ["category/Housing Assistance"],
        "ogTitle": "",
        "ogDescript": ""
    },
    ...
    "https://www.boycat.io/": {
        "userSummary": "website for the boycat app, useful for identifying companies to boycott.",
        "userTags": ["category/Boycott Tools & Apps"],
        "ogTitle": "",
        "ogDescript": ""
    },
    "https://boycottlist.xyz/about/": {
        "userSummary": "a website that crawls other boycott websites to identify and update companies to boycott, with data consolidated from other boycott-related websites.",
        "userTags": ["category/Boycott Tools & Apps"],
        "ogTitle": "",
        "ogDescript": ""
    },
    "https://disoccupied.com/": {
        "userSummary": "a website to search brands or take a photo of any product logo to get a quick answer on whether they support the ongoing occupation.",
        "userTags": ["category/Boycott Tools & Apps"],
        "ogTitle": "",
        "ogDescript": ""
    },
    "https://many.bio/nothanksboycott": {
        "userSummary": "The official webpage of links for No Thanks App",
        "userTags": ["category/Boycott Tools & Apps"],
        "ogTitle": "",
        "ogDescript": ""
    },
...
from getURLSnippet import scrape_og_stuff
import os
import json
def get_og_stuffs():
    ...
    #input_folder = scriptRelativePathToFullPath('retaggedNewsJsons')#"path/to/input/folder"
    output_folder = scriptRelativePathToFullPath('data')#"path/to/output/folder"
    
    finalData = {}
    counter = 0
    for urlKey in dataset.keys():
        print("getting og stuff for " + urlKey)

        print("counter: ", str(counter),"/",str(len(dataset)))
        counter += 1
        ogStuff = scrape_og_stuff(urlKey)

        finalData[urlKey] = dataset[urlKey]
        # finalData[urlKey]["ogTitle"] = ogStuff["og_title"]
        # finalData[urlKey]["ogDescript"] = ogStuff["og_description"]
        for key in ogStuff.keys():
            finalData[urlKey][key] = ogStuff[key]




    filename = scriptRelativePathToFullPath("data/data.json")
    try:
...
# getting og stuff for https://afsc.org/sites/default/files/2024-01/gazagenocideinfographic-1.pdf
# counter:  75 / 149
# Some characters could not be decoded, and were replaced with REPLACEMENT CHARACTER.
# getting og stuff for https://drive.google.com/file/d/17GcQtPruWzfkJmyW8-i9Qj4WTQ8WIT2A/view
# counter:  76 / 149